...
export default function Hero() {
  return (
    ...
    >
      {/* Dotted pattern */}
      <div className="absolute inset-0 opacity-[0.08] hero-dots" />
      ...
      <div className="w-[min(1160px,calc(100%-40px))] mx-auto min-h-[680px] grid grid-cols-[1.05fr_0.95fr] items-center relative z-[2] max-[850px]:grid-cols-1 max-[850px]:min-h-0">
        ...
        <div className="py-[65px] pb-[100px] max-[850px]:py-[70px] max-[850px]:pb-[140px]">
          <div className="flex items-center gap-2.5 uppercase tracking-[2px] text-xs text-[#e8c77f] mb-5">
            <span className="w-6 h-px bg-[#d9b56a]" />
            {HERO.presented}
            <span className="w-6 h-px bg-[#d9b56a]" />
          </div>

          <p className="text-sm text-[#e9c985] mb-1">{HERO.eyebrow}</p>
          ...
          <h1 className="font-serif font-extrabold text-[clamp(60px,7vw,98px)] leading-[1.02] tracking-[-3px] m-0 text-[#fff5e4] max-[560px]:text-[57px]">
            {HERO.titleLead} <em className="not-italic text-[#e7c37a]">{HERO.titleEm}</em>
            <br />
            {HERO.titleYear}
          </h1>
          ...
          <p className="max-w-[610px] text-[#e5d4ca] text-[15px]">{HERO.text}</p>
        ...
        {/* Decorative art */}
        <div className="h-[510px] relative max-[850px]:hidden" aria-hidden="true">
          ...
          <div className="absolute text-[#dcb86e] text-[70px] opacity-[0.65] left-[2%] top-[8%]">◌</div>
          <div className="absolute text-[#dcb86e] text-[70px] opacity-[0.65] right-[3%] bottom-[8%]">✧</div>
