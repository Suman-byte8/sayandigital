...
export default {
  ...
  hero: {
    ...
    credit: {
      kicker: "ওয়েবসাইট তৈরি করার জন্য যোগাযোগ করুন এই নাম্বারে ",
    },
    marquee:
      "আগামী ১৪ই সেপ্টেম্বর ২০২৬, সোমবার থেকে অনলাইনে আবেদনপত্র পূরণের কার্যক্রম শুরু হবে।",
  ...
  awardsSection: {
    ...
    options: [
      ...
      {
        value: "সেরা আলোকসজ্জা",
        title: "সেরা আলোকসজ্জা",
        desc: "আলো ও পরিবেশ",
      },
      {
